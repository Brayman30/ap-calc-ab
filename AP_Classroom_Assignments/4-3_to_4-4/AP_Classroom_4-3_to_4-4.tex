...
\begin{document}
	...
	\begin{questions}
		...
		\begin{solution}
			...
			Plug in knowns and simplify:
			$$\frac{2(5)(1) - 2(3)(\frac{1}{3} \cdot \frac{dx}{dt})} {2(4)} = \frac{10 - 6(\frac{1}{3} \cdot \frac{dx}{dt})} {8} =  \frac{10 - 2\frac{dx}{dt}}{8} = \frac{dx}{dt}$$ \\
			$$\frac{dx}{dt} + \frac{2}{8} (\frac{dx}{dt}) = \frac{10}{8}$$
			$$\frac{10}{8} (\frac{dx}{dt}) = \frac{10}{8}$$
			$$\boxed{\frac{dx}{dt} = 1}$$
		\end{solution}
