...
\begin{document}
	...
	\begin{questions}
		...
		\begin{solution}
			...
			Plug in knowns and simplify:
			$$\frac{4}{3} \pi (3(10)^2) (0.04) = \frac{4}{3} \pi (12) = \boxed{10\pi = \frac{dV}{dt}}$$
		\end{solution}
		%Q7
		...
		\begin{solution}
			...
			\begin{parts}
				\part %a
					In order to find Point $R$, where $y=0$, we should write the equation of line $\ell$ where $x=w$ (the x-coordinate of point $P$) and then plug in $y=0$ and solve for x:
					\begin{align*}
						y-\frac{1}{w^2} &= \left( \frac{dy}{dx}\bigg{|}_{x=w} \right) (x-w) \\
						-\frac{1}{w^2} &= \left( \frac{dy}{dx}\bigg{|}_{x=w} \right) (x-w) \\
						x &= \frac{-\frac{1}{w^2}}{\frac{dy}{dx}\big{|}_{x=w}} + w \\
						x &= (-w^2)(\frac{1}{\frac{dy}{dx}\big{|}_{x=w}}) + w
					\end{align*}
					Now, we need to plug in $w=3$:
					\begin{align*}
						 x &= (-3^2)(\frac{1}{\frac{dy}{dx}\big{|}_{x=3}}) + 3 \\
						 x &= (-9)(\frac{1}{\frac{-2}{(3)^3}}) + 3 \\
						 x &= (-9)(\frac{3^3}{-2}) + 3
					\end{align*}
				\part %b
